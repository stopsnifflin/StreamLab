...
public class StreamAPILab2 {
    public static void main(String[] args) {
        List<FoodTable> stats = new CsvToBeanBuilder<FoodTable>(new InputStreamReader(StreamAPILab.class.getResourceAsStream("/nutrition.csv")))
                .withType(FoodTable.class)
                .build()
                .parse();
